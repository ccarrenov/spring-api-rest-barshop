...
//		return generic.createOrUpdate(Country.class, RESOURCE, object, "country ID: " + object.getId());
//	}
//
...
//		return generic.findById(Country.class, RESOURCE, id);
//	}
//
...
//		return generic.deleteById(Country.class, RESOURCE, id);
//	}	
}
