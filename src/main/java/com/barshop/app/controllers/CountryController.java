...
public class CountryController implements BaseRestController<Country, Long> {
	...
	public ResponseEntity<Object> findAll() {
		Entity country = EntityReflexionUtil.newInstance(EntityConstant.COUNTRY_ENTITY);
		return generic.findAll(Country.class, country, RESOURCE, "countries");
	}
	...
	public ResponseEntity<Object> createOrUpdate(Country object) {
		Entity country = EntityReflexionUtil.newInstance(EntityConstant.COUNTRY_ENTITY);
		return generic.createOrUpdate(Country.class, country, Long.class, RESOURCE, object,
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = Country[].class),
			@ApiResponse(code = 500, message = "Failure") })
	@PostMapping(value = "create-countries", produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.TEXT_PLAIN_VALUE })
	@Override
	public ResponseEntity<Object> createAll(List<Country> objects) {
		Entity country = EntityReflexionUtil.newInstance(EntityConstant.COUNTRY_ENTITY);
		return generic.createAll(Country.class, country, Long.class, RESOURCE, objects, NUMBER_COMMIT_SIZE,
